...
def screen(
    ...
    batch_size: int = typer.Option(10, "--batch-size", help="Papers per LLM request (default 10). Benchmarked at 3.5× speedup vs single-paper with −2pp accuracy on Gemini 2.5 Flash. Use 1 to revert to single-paper mode."),
) -> None:
